...
int main(){
    ...
    stud.resize(stSk);
    Galvociai.resize(stSk);
    Vargsiukai.resize(stSk);
    ...
    for(int i = 0; i < stSk; i++){
        if(stud.at(i).galut < 5){
            Vargsiukai.at(i).Var = stud.at(i).Var;
            Vargsiukai.at(i).pVar = stud.at(i).pVar;
            Vargsiukai.at(i).galut = stud.at(i).galut;

            out2 << Vargsiukai.at(i).Var << " " << Vargsiukai.at(i).pVar << " " << Vargsiukai.at(i).galut << endl;
        }
            else if (stud.at(i).galut >= 5){
                Galvociai.at(i).Var = stud.at(i).Var;
                Galvociai.at(i).pVar = stud.at(i).pVar;
                Galvociai.at(i).galut = stud.at(i).galut;

                out1 << Galvociai.at(i).Var << " " << Galvociai.at(i).pVar << " " << Galvociai.at(i).galut << endl;
            }
    }
